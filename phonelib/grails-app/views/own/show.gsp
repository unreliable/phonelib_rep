		...
		<div id="show-own" class="content scaffold-show" role="main">
			...
			<ol class="property-list own">
				...
				<li class="fieldcontain">
					<span id="book-label" class="property-label"><g:message code="own.book.label" default="Book" /></span>
						...
						<span class="property-value" aria-labelledby="book-label"><g:link controller="book" action="show" id="${ownInstance?.book?.id}">${ownInstance?.book?.encodeAsHTML()}</g:link></span>
				...
				<li class="fieldcontain">
					<span id="user-label" class="property-label"><g:message code="own.user.label" default="User" /></span>
						...
						<span class="property-value" aria-labelledby="user-label"><g:link controller="user" action="show" id="${ownInstance?.user?.id}">${ownInstance?.user?.encodeAsHTML()}</g:link></span>
			...
			<g:form>
				<fieldset class="buttons">
					...
					<g:link class="edit" action="edit" id="${ownInstance?.id}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
