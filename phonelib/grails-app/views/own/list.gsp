...
<g:set var="entityName"
	value="${message(code: 'own.label', default: 'Own')}" />
...
<body>
		...
		<a href="#list-own" class="skip" tabindex="-1"><g:message
				...
				<thead>
					<tr>
						...
						<g:sortableColumn property="dateCreated"
							title="${message(code: 'own.dateCreated.label', default: 'Date Created')}" />
				...
				<tbody>
					<g:each in="${ownInstanceList}" status="i" var="ownInstance">
						<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
							...
							<td><g:link action="show" id="${ownInstance.id}">
									${fieldValue(bean: ownInstance, field: "book")}
								</g:link></td>

							<td><g:formatDate date="${ownInstance.dateCreated}" /></td>

							<td>
								${fieldValue(bean: ownInstance, field: "user")}
							</td>
