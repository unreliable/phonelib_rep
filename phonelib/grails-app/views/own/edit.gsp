...
<html>
	...
	<body>
		<a href="#edit-own" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-own" class="content scaffold-edit" role="main">
